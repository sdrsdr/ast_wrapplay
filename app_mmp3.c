 ...
 */
#define AST_MODULE "app_mmp3"
/*! \file
 *
 * \brief Silly application to play an MP3 file -- uses mpg123 (mod)
 *
...
static char *app = "MP3PlayerM";

static char *synopsis = "Play an MP3 file or stream (mod)";

static char *descrip = 
"  MP3PlayerM(location): Executes mpg123 to play the given location,\n"
...
AST_MODULE_INFO_STANDARD(ASTERISK_GPL_KEY, "Silly MP3 Application (mod)");
